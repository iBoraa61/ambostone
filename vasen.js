(() => {
  ...
  function openDetail(card) {
    ...
    setText(dType, ds.type, 'VASE'); setText(dTitle, ds.title, 'Produkt'); setText(dPrice, ds.price, ''); setText(dDesc, ds.desc, '');
  ...
  document.addEventListener('click', (e) => {
    ...
    if (!_t) return;
    location.href = 'produkt.html?src=vasen.html&p=' + encodeURIComponent(_t);
  });
  ...
  document.querySelectorAll('.wb-gridView .card').forEach(card => {
    ...
    a.href = 'produkt.html?src=vasen.html&p=' + encodeURIComponent(t);
